...
from .s3logger import put_content_to_s3
from .stringio_logger import get_string_io_logger
...
def my_function():
	...
	s3_log_path = "s3://my_bucket/python_s3_loggger_demo/{0}/".format(timestamp)
	try:
		#do any task
